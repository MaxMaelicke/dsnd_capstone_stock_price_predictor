        ...
        dbc.Col([
                ...
                html.Div([
                            ...
                            dcc.Markdown('''
                                         ...
                                         The methodology, model comparison and source code can be accessed on my [Github project](https://github.com/MaxMaelicke/dsnd_capstone_stock_price_predictor).

                                         This project was conducted as Capstone project for my **Data Scientist Nanodegree** at [**Udacity**](https://www.udacity.com/).
                                         Many thanks to **Plotly / Dash** for their awesome open-source graphing and dashboard libraries (https://plotly.com/) an to **Yahoo Finance** for the stock price data (https://finance.yahoo.com/).
